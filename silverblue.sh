...
if [[ $os = 'fedora' ]]; then
    ...
    echo -e "${color}// -- Add oh-my-bash (type 'exit' after install and set 'brainy' as theme :D) -- //${nocolor}"
    bash -c "$(curl -fsSL https://raw.githubusercontent.com/ohmybash/oh-my-bash/master/tools/install.sh)"

    echo -e "${color}// -- Add Homebrew -- //${nocolor}"
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)"

    echo -e "${color}// -- Add Node version manager -- //${nocolor}"
